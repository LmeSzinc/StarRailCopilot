...
class GeneratedConfig:
    ...
    DungeonSupport_Character = 'FirstCharacter'  # FirstCharacter, Evernight, DanHengPermansorTerrae, Hysilens, Cerydra, Phainon, Saber, Archer, Hyacine, Cipher, Castorice, Anaxa, Tribbie, Mydei, TheHerta, Aglaea, Sunday, Fugue, Rappa, Feixiao, Lingsha, Moze, Yunli, March7thTheHunt, Jiaoqiu, Firefly, Jade, Robin, Boothill, Acheron, Aventurine, Gallagher, BlackSwan, Sparkle, Misha, RuanMei, DrRatio, Xueyi, Huohuo, Argenti, Hanya, Jingliu, TopazNumby, Guinaifen, DanHengImbibitorLunae, FuXuan, Lynx, Blade, Kafka, Luka, SilverWolf, Luocha, Yukong, Seele, JingYuan, TrailblazerDestruction, TrailblazerPreservation, TrailblazerHarmony, TrailblazerRemembrance, Himeko, Welt, Gepard, Bronya, Clara, Yanqing, Bailu, March7thPreservation, DanHeng, Asta, Serval, Herta, Qingque, Sushang, Hook, Arlan, Sampo, Tingyun, Pela, Natasha, Cyrene
