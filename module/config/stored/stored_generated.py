...
class StoredGenerated:
    ...
    Item_Radiant_Prominence = StoredPlanner("Dungeon.Planner.Item_Radiant_Prominence")
    Item_Sea_Siren_Torn_Fin = StoredPlanner("Dungeon.Planner.Item_Sea_Siren_Torn_Fin")
    Item_Thunder_Strum = StoredPlanner("Dungeon.Planner.Item_Thunder_Strum")
    ...
    Item_Sneering_Harlequin = StoredPlanner("Dungeon.Planner.Item_Sneering_Harlequin")
    ...
    Item_Omnicolor_Fool_Own = StoredPlanner("Dungeon.Planner.Item_Omnicolor_Fool_Own")
    Item_Cosmic_Sandpit = StoredPlanner("Dungeon.Planner.Item_Cosmic_Sandpit")
    ...
    Item_Eternal_Lament = StoredPlanner("Dungeon.Planner.Item_Eternal_Lament")
    Item_Lucid_Awl = StoredPlanner("Dungeon.Planner.Item_Lucid_Awl")
