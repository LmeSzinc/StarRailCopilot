...
Stagnant_Shadow_Icicle = DungeonDetailed(
    ...
    cn='晋阶材料：冰（彦卿 / 镜流 / 阮•梅）',
    cht='晉階材料：冰（彥卿 / 鏡流 / 阮•梅）',
    en='Ascension: Ice (Yanqing / Jingliu / Ruan Mei)',
    jp='昇格素材：氷（彦卿 / 鏡流 / ルアン・メェイ）',
...
Stagnant_Shadow_Puppetry = DungeonDetailed(
    ...
    cn='晋阶材料：虚数（丹恒•饮月 / 砂金 / 真理医生）',
    cht='晉階材料：虛數（丹恆•飲月 / 砂金 / 真理醫生）',
    en='Ascension: Imaginary (Dan Heng • Imbibitor Lunae / Aventurine / Dr. Ratio)',
    jp='昇格素材：虚数（丹恒・飲月 / アベンチュリン / Dr.レイシオ）',
...
Stagnant_Shadow_Abomination = DungeonDetailed(
    ...
    cn='晋阶材料：量子（玲可 / 符玄 / 雪衣）',
    cht='晉階材料：量子（玲可 / 符玄 / 雪衣）',
    en='Ascension: Quantum (Lynx / Fu Xuan / Xueyi)',
    jp='昇格素材：量子（リンクス / 符玄 / 雪衣）',
    es='Ascension: Cuántico (Lynx / Fu Xuan / Xueyi)',
)
Stagnant_Shadow_Scorch = DungeonDetailed(
    id=12,
    name='Stagnant_Shadow_Scorch',
    cn='晋阶材料：火（托帕&账账 / 桂乃芬 / 忘归人）',
    cht='晉階材料：火（托帕&帳帳 / 桂乃芬 / 忘歸人）',
    en='Ascension: Fire (Topaz & Numby / Guinaifen / Fugue)',
    jp='昇格素材：炎（トパーズ&カブ / 桂乃芬 / 帰忘の流離人）',
    es='Ascension: Fuego (Topaz y Conti / Guinaifen / Fugue)',
)
...
Stagnant_Shadow_Nectar = DungeonDetailed(
    ...
    cn='晋阶材料：冰（米沙 / 大黑塔）',
    cht='晉階材料：冰（米沙 / 大黑塔）',
    en='Ascension: Ice (Misha / The Herta)',
    jp='昇格素材：氷（ミーシャ / マダム・ヘルタ）',
    es='Ascension: Hielo (Misha / Sra. Herta)',
)
Stagnant_Shadow_Roast = DungeonDetailed(
    ...
    cn='晋阶材料：量子（花火 / 翡翠）',
    cht='晉階材料：量子（花火 / 翡翠）',
    en='Ascension: Quantum (Sparkle / Jade)',
    jp='昇格素材：量子（花火 / ジェイド）',
    es='Ascension: Cuántico (Sparkle / Jade)',
)
Stagnant_Shadow_Ire = DungeonDetailed(
    id=17,
    name='Stagnant_Shadow_Ire',
    cn='晋阶材料：火（椒丘 / 灵砂 / 加拉赫 / 流萤）',
    cht='晉階材料：火（椒丘 / 靈砂 / 加拉赫 / 流螢）',
    en='Ascension: Fire (Jiaoqiu / Lingsha / Gallagher / Firefly)',
    jp='昇格素材：炎（椒丘 / 霊砂 / ギャラガー / ホタル）',
    es='Ascension: Fuego (Jiaoqiu / Lingsha / Gallagher / Luciérnaga)',
)
Stagnant_Shadow_Duty = DungeonDetailed(
    id=18,
    name='Stagnant_Shadow_Duty',
    cn='晋阶材料：物理（云璃 / 知更鸟 / 波提欧）',
    cht='晉階材料：物理（雲璃 / 知更鳥 / 波提歐）',
    en='Ascension: Physical (Yunli / Robin / Boothill)',
    jp='昇格素材：物理（雲璃 / ロビン / ブートヒル）',
    es='Ascension: Físico (Yunli / Robin / Boothill)',
)
...
Stagnant_Shadow_Mechwolf = DungeonDetailed(
    ...
    cn='晋阶材料：雷（貊泽 / 阿格莱雅）',
    cht='晉階材料：雷（貊澤 / 阿格萊雅）',
    en='Ascension: Lightning (Moze / Aglaea)',
    jp='昇格素材：雷（モゼ / アグライア）',
    es='Ascension: Rayo (Moze / Aglaea)',
)
Stagnant_Shadow_Gloam = DungeonDetailed(
    id=21,
    name='Stagnant_Shadow_Gloam',
    cn='晋阶材料：风（飞霄 / 那刻夏 / 风堇 / Saber）',
    cht='晉階材料：風（飛霄 / 那刻夏 / 風堇 / Saber）',
    en='Ascension: Wind (Feixiao / Anaxa / Hyacine / Saber)',
    jp='昇格素材：風（飛霄 / アナイクス / ヒアンシー / セイバー）',
    es='Ascension: Viento (Feixiao / Anaxa / Hyacine / Saber)',
)
Stagnant_Shadow_Sloggyre = DungeonDetailed(
    id=22,
    name='Stagnant_Shadow_Sloggyre',
    cn='晋阶材料：虚数（万敌 / 银狼LV.999）',
    cht='晉階材料：虛數（萬敵 / 銀狼LV.999）',
    en='Ascension: Imaginary (Mydei / Silver Wolf LV.999)',
    jp='昇格素材：虚数（モーディス / 銀狼LV.999）',
    es='Ascension: Imaginario (Midei / Silver Wolf Niv. 999)',
)
Stagnant_Shadow_Gelidmoon = DungeonDetailed(
    id=23,
    name='Stagnant_Shadow_Gelidmoon',
    cn='晋阶材料：量子（缇宝 / 赛飞儿 / 遐蝶 / Archer）',
    cht='晉階材料：量子（緹寶 / 賽飛兒 / 遐蝶 / Archer）',
    en='Ascension: Quantum (Tribbie / Cipher / Castorice / Archer)',
    jp='昇格素材：量子（トリビー / サフェル / キャストリス / アーチャー）',
    es='Ascension: Cuántico (Tribbie / Cífer / Castorice / Archer)',
)
Stagnant_Shadow_Deepsheaf = DungeonDetailed(
    id=24,
    name='Stagnant_Shadow_Deepsheaf',
    cn='晋阶材料：物理（白厄 / 海瑟音 / 丹恒•腾荒 / 爻光 / 绯英）',
    cht='晉階材料：物理（白厄 / 海瑟音 / 丹恆•騰荒 / 爻光 / 緋英）',
    en='Ascension: Physical (Phainon / Hysilens / Dan Heng • Permansor Terrae / Yao Guang / Evanescia)',
    jp='昇格素材：物理（ファイノン / セイレンス / 丹恒・騰荒 / 爻光 / 緋英）',
    es='Ascension: Físico (Fainón / Hysilens / Dan Heng - Permansor Terrae / Yao Guang / Evanescia)',
)
Stagnant_Shadow_Cinders = DungeonDetailed(
    id=25,
    name='Stagnant_Shadow_Cinders',
    cn='晋阶材料：风（刻律德菈 / 知更鸟•晴歌）',
    cht='晉階材料：風（刻律德菈 / 知更鳥•晴歌）',
    en='Ascension: Wind (Cerydra / Robin • Summeretto)',
    jp='昇格素材：風（ケリュドラ / ロビン・夏空の歌）',
    es='Ascension: Viento (Céridra / Robin Estival)',
)
...
Stagnant_Shadow_Devour = DungeonDetailed(
    ...
    cn='晋阶材料：量子（砂金•戏浪 / 远坂凛）',
    cht='晉階材料：量子（砂金•戲浪 / 遠坂凜）',
    en='Ascension: Quantum (Aventurine • Waveflair / Rin Tohsaka)',
    jp='昇格素材：量子（アベンチュリン・波と戯れる夏 / 遠坂凛）',
    es='Ascension: Cuántico (Aventurino Oleaje / Rin Tohsaka)',
)
