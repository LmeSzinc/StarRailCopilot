...
Stagnant_Shadow_Gloam = DungeonDetailed(
    ...
    cn='晋阶材料：风（飞霄 / 那刻夏 / 风堇）',
    cht='晉階材料：風（飛霄 / 那刻夏 / 風堇）',
    en='Ascension: Wind (Feixiao / Anaxa / Hyacine)',
    jp='昇格素材：風（飛霄 / アナイクス / ヒアンシー）',
    es='Ascension: Viento (Feixiao / Anaxa / Hyacine)',
)
...
Stagnant_Shadow_Gelidmoon = DungeonDetailed(
    ...
    cn='晋阶材料：量子（缇宝 / 遐蝶 / 赛飞儿）',
    cht='晉階材料：量子（緹寶 / 遐蝶 / 賽飛兒）',
    en='Ascension: Quantum (Tribbie / Castorice / Cipher)',
