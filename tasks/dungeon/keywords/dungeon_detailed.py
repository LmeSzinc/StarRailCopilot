...
Stagnant_Shadow_Deepsheaf = DungeonDetailed(
    ...
    cn='晋阶材料：物理（白厄 / 海瑟音 / 丹恒•腾荒 / 爻光）',
    cht='晉階材料：物理（白厄 / 海瑟音 / 丹恆•騰荒 / 爻光）',
    en='Ascension: Physical (Phainon / Hysilens / Dan Heng • Permansor Terrae / Yao Guang)',
    jp='昇格素材：物理（ファイノン / セイレンス / 丹恒・騰荒 / 爻光）',
    es='Ascension: Físico (Fainón / Hysilens / Dan Heng - Permansor Terrae / Yao Guang)',
)
