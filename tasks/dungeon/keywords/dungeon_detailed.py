...
Stagnant_Shadow_Gloam = DungeonDetailed(
    ...
    cn='晋阶材料：风（飞霄 / 那刻夏）',
    cht='晉階材料：風（飛霄 / 那刻夏）',
    en='Ascension: Wind (Feixiao / Anaxa)',
    jp='昇格素材：風（飛霄 / アナイクス）',
    es='Ascension: Viento (Feixiao / Anaxa)',
)
...
Stagnant_Shadow_Gelidmoon = DungeonDetailed(
    ...
    cn='晋阶材料：量子（缇宝 / 遐蝶）',
    cht='晉階材料：量子（緹寶 / 遐蝶）',
    en='Ascension: Quantum (Tribbie / Castorice)',
    jp='昇格素材：量子（トリビー / キャストリス）',
    es='Ascension: Cuántico (Tribbie / Castorice)',
)
