...
FILTER_CONFIRM = ButtonWrapper(
    name='FILTER_CONFIRM',
    cn=Button(
        file='./assets/cn/item/relics/FILTER_CONFIRM.png',
    ...
    en=Button(
        file='./assets/en/item/relics/FILTER_CONFIRM.png',
        area=(1008, 640, 1248, 688),
        search=(988, 620, 1268, 708),
        color=(206, 206, 207),
        button=(1008, 640, 1248, 688),
...
FILTER_RESET = ButtonWrapper(
    name='FILTER_RESET',
    cn=Button(
        file='./assets/cn/item/relics/FILTER_RESET.png',
    ...
    en=Button(
        file='./assets/en/item/relics/FILTER_RESET.png',
        area=(832, 640, 992, 688),
        search=(812, 620, 1012, 708),
        color=(200, 200, 201),
        button=(832, 640, 992, 688),
...
GOTO_ENHANCE_FILTER = ButtonWrapper(
    name='GOTO_ENHANCE_FILTER',
    share=Button(
        file='./assets/share/item/relics/GOTO_ENHANCE_FILTER.png',
        area=(161, 652, 183, 675),
        search=(141, 632, 203, 695),
        color=(187, 189, 191),
        button=(161, 652, 183, 675),
    ),
)
...
GOTO_SALVAGE_FILTER = ButtonWrapper(
    name='GOTO_SALVAGE_FILTER',
    share=Button(
        file='./assets/share/item/relics/GOTO_SALVAGE_FILTER.png',
        area=(443, 647, 465, 670),
        search=(423, 627, 485, 690),
        color=(185, 186, 188),
...
MAIN_STAT_SELECT = ButtonWrapper(
    ...
    share=Button(
        file='./assets/share/item/relics/MAIN_STAT_SELECT.png',
        area=(832, 394, 872, 434),
        search=(812, 374, 892, 454),
        color=(236, 186, 105),
...
SALVAGE_ORDER_ASCENDING = ButtonWrapper(
    name='SALVAGE_ORDER_ASCENDING',
    share=Button(
        file='./assets/share/item/relics/SALVAGE_ORDER_ASCENDING.png',
...
SALVAGE_ORDER_DESCENDING = ButtonWrapper(
    name='SALVAGE_ORDER_DESCENDING',
    share=Button(
        file='./assets/share/item/relics/SALVAGE_ORDER_DESCENDING.png',
...
SET_SELECT = ButtonWrapper(
    name='SET_SELECT',
    share=Button(
        file='./assets/share/item/relics/SET_SELECT.png',
...
SUB_STAT_SELECT = ButtonWrapper(
    ...
    share=Button(
        file='./assets/share/item/relics/SUB_STAT_SELECT.png',
        area=(832, 580, 872, 620),
        search=(812, 560, 892, 640),
        color=(231, 183, 106),
