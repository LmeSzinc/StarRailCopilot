...
Four_Phases_Crossing_the_River_to_Check_the_King = ItemTrace(
    id=52,
    name='Four_Phases_Crossing_the_River_to_Check_the_King',
    cn='四相，过河照君',
    cht='四相，過河照君',
    en='Four Phases, Crossing the River to Check the King',
    jp='四相、過河照君',
    es='Brillo del cruce real',
    rarity='NotNormal',
    item_id=110281,
    item_group=1221,
    dungeon_id=1035,
)
Sixen_King_Rook_Fork = ItemTrace(
    id=53,
    name='Sixen_King_Rook_Fork',
    cn='六合，王手飞车',
    cht='六合，王手飛車',
    en='Sixen, King-Rook Fork',
    jp='六合、王手飛車取り',
    es='Volauto del jaque universal',
    rarity='Rare',
    item_id=110282,
    item_group=1221,
    dungeon_id=1035,
)
Omnicolor_Fool_Own = ItemTrace(
    id=54,
    name='Omnicolor_Fool_Own',
    cn='万色，愚者自将',
    cht='萬色，愚者自將',
    en="Omnicolor, Fool's Own",
    jp='万色、愚者のメイト',
    es='Bufón soberano multicolor',
    rarity='VeryRare',
    item_id=110283,
    item_group=1221,
    dungeon_id=1035,
)
Celestial_Globe = ItemTrace(
    id=55,
    ...
    en='Celestial Globe',
    jp='天体模型',
    es='Maqueta del cuerpo celeste',
    rarity='NotNormal',
    item_id=110291,
    item_group=1223,
    dungeon_id=1034,
)
Galaxy_Framework = ItemTrace(
    id=56,
    name='Galaxy_Framework',
    cn='星系框架',
    cht='星系框架',
    en='Galaxy Framework',
    jp='星系模型',
